    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-3xl font-bold">Bing Search Volume</h1>
        </div>
        {results.length > 0 && (
          <div className="flex items-center space-x-2">
            <Button
      ...
      <p className="text-muted-foreground">
        Analysiere das Suchvolumen und die Metriken für Keywords in der Bing Suchmaschine.
      </p>

      <Card>
        <CardHeader>
          <CardTitle>Keyword Suchvolumen-Analyse</CardTitle>
          <CardDescription>
            Analysiere das Suchvolumen und die Metriken für deine Keywords in Bing.
          </CardDescription>
        </CardHeader>
        <CardContent>

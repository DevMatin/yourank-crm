...
export default function GoogleAdsAdTrafficPage() {
  const { t, tCommon, pageTitle, searchPlaceholder, analyzeButton, locationLabel, languageLabel, loadingText, creditsText, resultsText } = useKeywordsPageTranslations('google-ads-ad-traffic');
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('adTraffic')}</CardTitle>
          <CardDescription>
            {t('subtitle')}
          </CardDescription>
        </CardHeader>
